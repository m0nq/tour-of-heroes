...
describe('Tutorial part 6', () => {
  ...
  function getPageElts() {
    let navElts = element.all(by.css('cq-root nav a'));

    return {
      navElts: navElts,

      appDashboardHref: navElts.get(0),
      appDashboard: element(by.css('cq-root cq-dashboard')),
      topHeroes: element.all(by.css('cq-root cq-dashboard > div h4')),

      appHeroesHref: navElts.get(1),
      appHeroes: element(by.css('cq-root cq-heroes')),
      allHeroes: element.all(by.css('cq-root cq-heroes li')),
      selectedHeroSubview: element(by.css('cq-root cq-heroes > div:last-child')),

      heroDetail: element(by.css('cq-root cq-hero-detail > div')),
